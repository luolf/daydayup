 ...
 * Hack for loop table
 */
public class MyHackLoopTableRenderPolicy implements RenderPolicy {

    private String prefix;
    private String suffix;

    public MyHackLoopTableRenderPolicy() {
        this("[", "]");
    }

    public MyHackLoopTableRenderPolicy(String prefix, String suffix) {
        this.prefix = prefix;
        this.suffix = suffix;
    }
