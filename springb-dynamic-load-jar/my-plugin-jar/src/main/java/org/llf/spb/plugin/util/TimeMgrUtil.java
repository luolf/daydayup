package org.llf.spb.plugin.util;
...
public class TimeMgrUtil {
     ...
     * @return 返回值说明
     * @param date 被转换日期
     * @param formatOut 时间输出格式，默认使用yyyy-MM-dd HH:mm:ss
     * @author luolifeng
     * Date 2019/4/3
     */
    public static String getDate2Str(Date date,String formatOut) {
        if(formatOut==null){
        ...
        public static Date dateAdd(Date date, int days, boolean includeTime) throws ParseException{
            ...
            if(!includeTime){
                SimpleDateFormat sdf = new SimpleDateFormat(TimeMgrUtil.DATE_PATTERN);
        ...
        public static String dateFormat(Date date, String pattern) throws ParseException {
            if(pattern==null || "".equals(pattern)){
                pattern = TimeMgrUtil.DATE_PATTERN;
            }
        ...
        public static String dateTimeToDateString(Date dateTime) throws ParseException{
            String dateTimeString = TimeMgrUtil.dateFormat(dateTime, TimeMgrUtil.DATE_TIME_PATTERN);
...
public  static void main(String[] a) throws ParseException {
        TimeMgrUtil.dateParse("2019-04-03 18:00:00",TimeMgrUtil.DATE_TIME_PATTERN);
    }
}
